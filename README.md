...
|웹|모두의말뭉치	2020 (버전 1.0)|raw| """title"": ""비타민 사기 진짜 어려워.."", ""form"": ""오메가3와 비타민C, 달맞이꽃종자유 등을 사려고 몇 시간을 검색하며 공부했다. 그 결과 오염되지 않은 바다에서 잡힌 먹이사슬의 하단에 있는 생선이 좋다고 들었는데(중략)|블로그 11,521건 게시판 9,089건 누리 소통망 1,989,656건 -리뷰: 96,810건|사전 승인 및 출판후 알)|2023년 8월 검색 결과에서는 모두의 말뭉치 홈페이지에 없음|
